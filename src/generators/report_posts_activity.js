...
async function generateReport() {
    ...
    try {
        ...
        fs.writeFileSync(path.join(__dirname, '../../reports', 'posts_activity_report.pdf'), response.data);
        console.log('Success! Report saved to reports/posts_activity_report.pdf');
    } catch (e) {
