...
async function generateReport() {
    ...
    try {
        ...
        fs.writeFileSync(path.join(__dirname, '../pdfs', 'search_content_report.pdf'), response.data);
        console.log('Success! Report saved to reports/pdfs/search_content_report.pdf');
    } catch (e) {
