...
async function generateReport() {
    ...
    try {
        ...
        fs.writeFileSync(path.join(__dirname, '../pdfs', 'group_performance_report.pdf'), response.data);
        console.log('Success! Report saved to reports/pdfs/group_performance_report.pdf');
    } catch (e) {
