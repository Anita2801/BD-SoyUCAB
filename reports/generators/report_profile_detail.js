...
async function generateReport() {
    ...
    try {
        ...
        fs.writeFileSync(path.join(__dirname, '../pdfs', 'profile_detail_report.pdf'), response.data);
        console.log('Success! Report saved to reports/pdfs/profile_detail_report.pdf');
    } catch (e) {
